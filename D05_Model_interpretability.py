...
def plot_distribution_subplot(Card_ID, data, station_name, num_state, PLOT_GRAPH, bw, save_fig, act_label = None):
    ...
    fig, axs = plt.subplots(4, num_state, figsize=(15, 16))
    ...
    for i in state_id_list:
        ...
        if PLOT_GRAPH['START_LOCATION']:
            ...
            ax.set_xticklabels(name_list, rotation = 0, fontsize = font_size - 2)
        ...
        if PLOT_GRAPH['LOCATION']:
            ...
            ax.set_xticklabels(points_group['STATION'], rotation = 0, fontsize = font_size - 2)
    ...
    if save_fig == 0:
        ...
        plt.savefig('img/patterns_distribution_'+ str(Card_ID) + '.png', dpi=200)
...
if __name__ == '__main__':
    ...
    if OBTAIN_TEST_ID:
        ...
        individual_ID_list_test_used = [910024208] # [958765943, 910506778, 997602015, 944546044, 910024208, 946346500, 949263007, 954393193, 997872944, 941974385]
        # 994326032 910024208
    ...
    if PLOT_DISTRIBUTION:
        for Card_ID in individual_ID_list_test_used:
            ...
            if flag == 1: # all figures are available
                plot_distribution_subplot(Card_ID, final_data, station_name, num_act, PLOT_GRAPH, bw = bw, save_fig=1,act_label = act_label)
                plot_transition_matrix(Card_ID, final_data, num_act, act_label, save_fig=1)
            else:
                plot_distribution(Card_ID, final_data,station_name,num_act,PLOT_GRAPH,bw = bw, save_fig = 1)
